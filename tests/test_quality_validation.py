...
class TestCoordinateValidator:
    ...
    def test_missing_coordinates(self):
        ...
        data = [
            {'name': 'No coordinates'},
            {'description': 'Also no coordinates'}
        ]
...
class TestAttributeValidator:
    ...
    def test_custom_required_fields(self):
        ...
        custom_validator = AttributeValidator({
...
class TestCrossReferenceValidator:
    ...
    def test_exact_name_match(self):
        ...
        primary_data = [
            {'name': 'Test Location', 'lat': 57.32, 'lon': -2.88}
        ]
        reference_data = [
    ...
    def test_location_based_match(self):
        ...
        primary_data = [
            {'name': 'Primary Location', 'lat': 57.32, 'lon': -2.88}
        ]
        reference_data = [
    ...
    def test_data_conflicts(self):
        ...
        reference_data = [
            {'name': 'Test Restaurant', 'type': 'french', 'lat': 57.32, 'lon': -2.88}  # Conflict in type
        ]
    ...
    def test_missing_references(self):
        ...
        primary_data = [
            {'name': 'Unique Location', 'lat': 57.32, 'lon': -2.88}
        ]
        reference_data = [
            {'name': 'Different Location', 'lat': 57.35, 'lon': -2.85}
        ]
...
class TestQualityValidationIntegration:
    ...
    def test_validate_with_output_directory(self):
        ...
        data_sources = {
            'test_data': [{'name': 'Test', 'lat': 57.32, 'lon': -2.88}]
        }
