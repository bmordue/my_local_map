...
class TestDataPipeline:
    ...
    def test_prepare_osm_data_existing_file(self, sample_area_config, sample_bbox):
        ...
        with patch("pathlib.Path.exists", return_value=True), patch(
            "utils.data_pipeline.validate_osm_data_quality", return_value=True
        ):

            osm_file, success = prepare_osm_data(
    ...
    def test_prepare_osm_data_download_success(self, sample_area_config, sample_bbox):
        ...
        with patch("pathlib.Path.exists", return_value=False), patch(
            "utils.data_pipeline.download_osm_data", return_value=True
    ...
    def test_prepare_osm_data_download_failure(self, sample_area_config, sample_bbox):
        ...
        with patch("pathlib.Path.exists", return_value=False), patch(
            "utils.data_pipeline.download_osm_data", return_value=False
        ):
    ...
    @pytest.mark.unit
    def test_process_data_pipeline_no_hillshading(
