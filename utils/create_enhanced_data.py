...
def create_enhanced_tourist_database():
    ...
    attractions = [
        (
            ...
            "historic",
            "castle",
            "16th-century tower house with star-shaped curtain wall",
            57.335,
            -2.865,
            "Apr-Sep: 9:30-17:30",
        ...
        (
            "Lumsden Heritage Trail",
            "tourism",
            "trail",
            "Self-guided heritage walk through village",
            57.3167,
            -2.8833,
            "Always open",
            None,
        ...
        (
            "Bellabeg Forest Walks",
            "natural",
            "forest",
            "Network of woodland paths with wildlife viewing",
            57.340,
            -2.850,
            "Always open",
            None,
    ...
    accommodation = [
        (
            ...
            "hotel",
            3,
            "Traditional Highland inn with modern amenities",
            57.315,
            -2.885,
            12,
            "££",
            "www.corgarffarms.com",
            "+44 1975 651234",
            "Restaurant, Bar, Wifi",
            True,
            True,
        ...
        (
            ...
            "bed_and_breakfast",
            None,
            "Working farm offering comfortable rooms",
            57.312,
            -2.879,
            6,
            "£",
            "www.lumsdenfarm.co.uk",
            "+44 1975 651567",
            "Breakfast, Farm tours",
            True,
            True,
            True,
        ),
        (
            ...
            "holiday_cottage",
            None,
            "Self-catering cottage for families",
            57.308,
            -2.888,
            8,
            "££",
            "www.highland-cottage.com",
            "+44 1975 651890",
            "Kitchen, Garden, Parking",
            True,
            True,
            True,
        ),
        (
            ...
            "hostel",
            None,
            "Basic accommodation for walkers",
            57.325,
            -2.872,
            16,
            "£",
    ...
    dining = [
        ...
        (
            ...
            "restaurant",
            "Fish & Chips",
            "Fresh local fish, takeaway available",
            57.318,
            -2.882,
            "£",
            "17:00-21:00 (Closed Sun)",
            None,
            "+44 1975 651777",
            False,
            True,
        ...
        (
            ...
            -2.885,
            "£££",
            "18:00-22:00 (Closed Mon-Tue)",
            "www.highland-restaurant.com",
            "+44 1975 651234",
            True,
            False,
            True,
    ...
    activities = [
        (
            ...
            "tourism",
            "guided_tour",
            "Expert-led tour of Corgarff Castle",
            57.335,
            -2.865,
            "1.5 hours",
            "Easy",
        ...
        (
            ...
            "outdoor",
            "bushcraft",
            "Learn traditional woodland skills",
            57.340,
            -2.850,
            "Half day",
            "Moderate",
        ...
        (
            ...
            "tourism",
            "photography",
            "Capture stunning Highland scenery",
            57.330,
            -2.875,
            "4 hours",
            "Easy",
        ...
        (
            ...
            "agritourism",
            "farm_visit",
            "Meet animals and learn about farming",
            57.312,
            -2.879,
            "2 hours",
            "Easy",
    ...
    trails = [
        (
            "Lumsden Village Loop",
            "Easy circular walk around village",
            57.3167,
            -2.8833,
            57.3167,
            -2.8833,
            ...
            True,
            True,
            "Benches, Village shop",
            "Church, Heritage signs",
        ),
        (
            "Corgarff Castle Walk",
            "Historic walk to castle and back",
            57.3167,
            -2.8833,
            57.335,
            -2.865,
        ...
        (
            "Bellabeg Forest Trail",
            "Woodland circuit with wildlife",
            57.340,
            -2.850,
            57.340,
            -2.850,
        ...
        (
            ...
            True,
            "Bridge access",
            "River pools, Fishing spots",
        ),
        (
            "Highland Viewpoint Trek",
...
def export_database_to_geojson(db_path):
    ...
    for trail in trails:
        ...
        feature = {"type": "Feature", "geometry": geometry, "properties": trail_dict}
        trail_features.append(feature)

    trails_geojson = {"type": "FeatureCollection", "features": trail_features}
